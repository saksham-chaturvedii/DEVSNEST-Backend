const express = require("express"); // Got express from?
const app = express();
// Express passes a function definition (export = e) which we need to call before moving ahead and being able to use express.

app.listen(1111); // We launched our local server at the port 1111 where express will be listening to the requests.
...
// ?xyz="saksham" -> xyz's value can be found in res.query [query parameter, contained in variables after ? and before &]
// /:abc/products -> abc's value can be found in res.param [route parameter, contained in the URL]
